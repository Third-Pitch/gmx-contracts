...
async function checkPricesBase() {
  const vaultPriceFeed1 = await contractAt("VaultPriceFeed", "0xF3018828AC3D8d393936d3eF5dd9A0df6177868e")
  // let vaultPriceFeed2
  const vaultPriceFeed2 = await contractAt("VaultPriceFeed", "0xF3018828AC3D8d393936d3eF5dd9A0df6177868e")

  const { eth, btc, link, dai, usdt, usdc } = tokens
  const tokenArr = [eth, btc, link, dai, usdt, usdc]
