...
async function main() {
  const { feeGlpTracker, stakedGlpTracker, glpManager } = await getValues()

  const rewardRouter = await contractAt("RewardRouterV2", "0xABB789E3c4bB3c3a548f6B020647655F0619d0BF")
